      ...
      <form action="{{URL::to('/register')}}" method="post">
         ...
         @endforeach
                  ...
                  <div class="wrap-input100 validate-input" >
                     <input class="input100" type="text" name="admin_name" value="{{old('admin_name')}}" placeholder="Điền tên" >
                  ...
                  <div class="wrap-input100 validate-input" >
                     <input class="input100" type="text" name="admin_phone"   value="{{old('admin_phone')}}"  placeholder="Điền phone">
                     <span class="focus-input100"></span>
                  </div>
                    <div class="wrap-input100 validate-input" >
                  ...
                  <div class="container-login100-form-btn m-t-17">
                     <button type="submit"  value="Đăng ký" class="login100-form-btn"  name="login"> Đăng ký</button>
                  </div>
