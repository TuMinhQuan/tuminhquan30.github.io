...
<link href="{{asset('public/backend/DataTables/css/jquery.dataTables.min.css')}}" rel="stylesheet"/>
         ...
         <div class="top-nav clearfix">
            ...
            <ul class="nav pull-right top-menu">
               ...
               <li class="dropdown">
                  ...
                  <img alt="" src="{{('public/backend/images/quan.jpg')}}">
                  <span class="username">
                  <?php
                  ...
                  <li>
                    ...
                    <li class="sub-menu">
                     ...
                     <ul class="sub">
                        ...
                        <li><a href="{{URL::to('/list-info')}}">Liệt kê thông tin website</a></li>
...
{{-- // format gia san pham trong them và update sản phẩm --}}
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#file').change(function(){
        ...
        if(files.length>5){
          ...
          error += '<p> Bạn ko được bỏ trống ảnh</p>';
        ...
        //blur khi  click vào eidt, thì khi click ra sẽ 
          ...
          // xóa gallery hình ảnh
            ...
            $.ajax({
                  ...
                  success:function(data){
                      load_gallery();
                    $('#error_gallery').html('<span class = text-danger>Cap nhat hinh anh thành công</span>');
                  }
            });
 ...
 {{--   <script type="text/javascript">
      $(document).ready(function(){
          ...
          // thêm phí vận chuyển cùng class
          ...
          // nếu chọn id=city thì province biến wards sẽ nhận giá trị
          $('.choose').on('change',function(){
              var action = $(this).attr('id');
              var ma_id = $(this).val();
              var _token = $('input[name="_token"]').val();
              var result = '';
             // alert(action); Chọn thành phố thì sẽ lấy được giá trị: city, matp. và token
            //  alert(matp);
            //   alert(_token);
              if(action=='city'){
                  result = 'province';
