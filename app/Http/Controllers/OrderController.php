...
{
	//update số lượng trong đơn hàng
  ...
  border: 1px solid black;
	...
	public function view_order($order_code){
		...
		// gửi qua 2 trường hợp  tính giảm theo % và tiền, Nếu gửi qua view order ko dùng đk thì nó sẽ ko 
		// hiểu tính % . Vì trong csdl 10% hiểu chỉ 10. Nên nếu lấy qua view order thì sẽ hiểu là - cho 10 đồng
		if($product_coupon != 'no'){
			$coupon = Coupon::where('coupon_code',$product_coupon)->first();
			$coupon_condition = $coupon->coupon_condition;
			$coupon_number = $coupon->coupon_number;
